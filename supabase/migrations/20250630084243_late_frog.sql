/*
  # Update Platform to Pay-Per-Hire Model

  1. Changes
    - Update RLS policies to allow recruiters to view all developer profiles
    - Update messaging permissions to allow recruiters to message any developer
    - Ensure developers can only respond to recruiter messages
    - Update job role policies to make job listings visible to all users
