/*
  ...
  1. Changes
    ...
    - Update handle_new_user function to capture installation_id from GitHub metadata
    - Update create_developer_profile function to handle github_installation_id parameter
...
-- Add github_installation_id column to developers table if it doesn't exist
...
-- Update the handle_new_user function to capture installation_id from GitHub metadata
