/*
  # Add Profile Picture URL to Developers

  1. Changes
    - Add profile_pic_url column to developers table
    - Update handle_new_user function to populate profile_pic_url from GitHub metadata
