/*
  ...
  1. New Tables
    - `users` - Main user profiles (admin, recruiter, developer)
    - `developers` - Developer-specific information and GitHub data
    - `recruiters` - Recruiter-specific information and company data
    - `job_roles` - Job postings created by recruiters
    - `assignments` - Developer assignments to specific job roles
    - `messages` - Communication between recruiters and developers
    - `hires` - Successful hire records with salary information
...
-- Insert default admin user (you can change this email to your own)
