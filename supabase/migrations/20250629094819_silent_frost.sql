/*
  # Fix Developer Profile Creation Functions

  1. Functions Updated
    - Drop and recreate create_developer_profile with correct parameter names
    - Drop and recreate create_user_profile with proper function signature
    - Ensure all functions use desired_salary instead of hourly_rate

  2. Changes Made
    - Fixed parameter mismatch between auth hook and database functions
    - Added proper handling for new portfolio and skills fields
    - Updated function signatures to match current usage
*/
...
-- Create the create_developer_profile function with correct parameters
...
-- Create the create_user_profile function with proper signature
