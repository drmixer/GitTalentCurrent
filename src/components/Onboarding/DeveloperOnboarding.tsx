...
export const DeveloperOnboarding = () => {
  const { user, userProfile, createDeveloperProfile } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const success = await createDeveloperProfile(formData);
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-lg mx-auto">
            Welcome, {userProfile?.name}! Let's set up your developer profile to start receiving job opportunities.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6">
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-2xl hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                {loading ? (
                  <div className="flex items-center">
