      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-slate-100 rounded-3xl p-12 border border-gray-200">
          <div className="flex justify-around items-center mb-12">
            <img src="https://rsfebnaixdwkqxzadvub.supabase.co/storage/v1/object/public/illustrations/undraw_portfolio-website_838t.svg" alt="Recruiter reviewing portfolios" className="w-2/5" />
            <img src="https://rsfebnaixdwkqxzadvub.supabase.co/storage/v1/object/public/illustrations/undraw_proud-coder_9prj.svg" alt="Developer proud of their code" className="w-2/5" />
          </div>
