/*
  # Fix portfolio items table and policies

  1. Create portfolio_items table
  2. Enable RLS
  3. Create policies for portfolio items
  4. Create indexes
  5. Create trigger for updated_at
  6. Update developer profile function
*/
...
-- Create portfolio_items policies (without IF NOT EXISTS which causes syntax errors)
